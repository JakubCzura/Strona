...
<div class="container">
  ...
  <div class="row"> 
    ...
    <ul class="list">
      <li> 
        <h3>Zagłosuj na ten na album</h3>          
        <img src="graphics/thumbUp.jpg" alt="facebook" width="50" height="50"/> <br/>
        <p>Liczba polubień:</p>
        <p>2121</p>
        <img src="graphics/thumbDown.jpg" alt="youtube" width="50" height="50"/> <br/>
        <p>Liczba niepolubień:</p>
        <p>212</p>
      </li>
