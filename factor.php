...
<div class="container">
  ...
  <div class="row"> 
    ...
    <div class="col-sm-4 photo">
      <h3>The X Factor</h3>
      <p>The X Factor – dziesiąty studyjny album grupy wydany w 1995 roku. 
        Jako wokalista grupy wystąpił po raz pierwszy Blaze Bayley, który zastąpił chcącego skupić się na 
        solowych wydawnictwach Bruce'a Dickinsona.
        Płyta uważana za najbardziej pesymistyczną w twórczości grupy, jest to związane z tragediami życiowymi 
        jej lidera, Steve'a Harrisa takimi śmierć ojca. </p>            
    </div>
    <div class="col-sm-4 photo">             
      <img src="graphics/10.jpg" alt="iron maiden album" style="width:100%; height:auto;">
    </div>
  ...
  <div class="youtubeLink">
    <h2> Link do posłuchania w YouTube:
      <br/>
      <a href="https://www.youtube.com/watch?v=le2i7s_BGI4&list=OLAK5uy_mLFchbwNlR7QDJmHA5TPTeJ9WbBqOH7Po" target="_blank" title="Kliknij, by otworzyć w YouTube">  
