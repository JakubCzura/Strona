...
<div class="container">
  ...
  <div class="row"> 
    ...
    <div class="col-sm-4 photo">
      <h3>Killers</h3>
      <p> Killers – drugi album brytyjskiego zespołu, który został wydany 9 lutego 1981 roku.
        Było to pierwsze wydawnictwo z Adrianem Smithem jako gitarzystą prowadzącym i zarazem ostatnie z wokalistą Paulem Di’Anno. 
        Wszystkie piosenki z wyjątkiem Murders in the Rue Morgue i Killers zostały skomponowane jeszcze przed wydaniem debiutanckiej
        płyty zespołu. Album zawiera dwa utwory instrumentalne The Ides of March oraz Genghis Khan, co w całej twórczości zespołu 
        stanowi rzadkość. Tekst do Murders in the Rue Morgue powstał na motywach utworu Edgara Allana Poe o tym samym tytule.</p>            
    </div>
    <div class="col-sm-4 photo">             
      <img src="graphics/2.jpg" alt="iron maiden album" style="width:100%; height:auto;">
    </div>
  ...
  <div class="youtubeLink">
    <h2> Link do posłuchania w YouTube:
      <br/>
      <a href="https://www.youtube.com/watch?v=rGJnjSATu50&list=OLAK5uy_k7BxSdOVbNPvjcMCzbgfpq9p2vPjqxaWU" target="_blank" title="Kliknij, by otworzyć w YouTube">  
